...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium uniform manufacturing, embroidery, and bulk production for businesses, schools, and organizations across the UAE." },
      { name: "author", content: "Al Taj Uniforms" },
      ...
      { property: "og:site_name", content: "Al Taj Uniforms" },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        url: "/",
        telephone: "+971502570505",
        email: "altajuniforms@gmail.com",
        address: { "@type": "PostalAddress", addressLocality: "Dubai", addressCountry: "AE" },
        description: "Custom uniform manufacturing, embroidery, and bulk production in the UAE.",
      }),
    }],
  }),
